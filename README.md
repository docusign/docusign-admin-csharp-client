...
### Version Information
- **API version**: v2.1
- **Latest SDK version (Including prerelease)**: 2.0.0-rc5
...
<a id="changeLog"></a>
## Changelog
You can refer to the complete changelog [here](https://github.com/docusign/docusign-admin-csharp-client/blob/master/CHANGELOG.md).
