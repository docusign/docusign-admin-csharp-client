...
namespace DocuSign.Admin.Model
{
    ...
    public partial class AddUserResponse :  IEquatable<AddUserResponse>, IValidatableObject
    {
        ...
        public AddUserResponse(Guid? Id = default(Guid?), int? SiteId = default(int?), string UserName = default(string), string FirstName = default(string), string LastName = default(string), string Email = default(string), string LanguageCulture = default(string), string FederatedStatus = default(string))
        {
            this.Id = Id;
            this.SiteId = SiteId;
        ...
        public List<AddUserResponseAccountProperties> Accounts { get; private set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddUserResponse);
        }

        /// <summary>
        /// Returns true if AddUserResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AddUserResponse to be compared</param>
        /// <returns>Boolean</returns>
