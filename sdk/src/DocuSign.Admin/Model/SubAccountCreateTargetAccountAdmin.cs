...
namespace DocuSign.Admin.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubAccountCreateTargetAccountAdmin :  IEquatable<SubAccountCreateTargetAccountAdmin>, IValidatableObject
    {
        public SubAccountCreateTargetAccountAdmin()
        {
            // Empty Constructor
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubAccountCreateTargetAccountAdmin" /> class.
        /// </summary>
        ...
        public SubAccountCreateTargetAccountAdmin(string Email = default(string), string FirstName = default(string), string LastName = default(string), LocaleEnum? Locale = default(LocaleEnum?))
        {
            this.Email = Email;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SubAccountCreateTargetAccountAdmin);
        }

        /// <summary>
        /// Returns true if SubAccountCreateTargetAccountAdmin instances are equal
        /// </summary>
        /// <param name="other">Instance of SubAccountCreateTargetAccountAdmin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubAccountCreateTargetAccountAdmin other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
