...
namespace DocuSign.Admin.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationConnectConfigurationRequest :  IEquatable<OrganizationConnectConfigurationRequest>, IValidatableObject
    {
        public OrganizationConnectConfigurationRequest()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationConnectConfigurationRequest" /> class.
        /// </summary>
        ...
        public OrganizationConnectConfigurationRequest(Guid? ConnectId = default(Guid?), string ConfigurationType = default(string), string AllowEnvelopePublish = default(string), string UrlToPublishTo = default(string), string DeliveryMode = default(string), List<string> Events = default(List<string>), string AssociatedFilterSelection = default(string), List<string> GroupIds = default(List<string>), List<string> AccountIds = default(List<string>), List<string> UserIds = default(List<string>), string Name = default(string), string SignMessageWithX509Certificate = default(string), string IncludeOAuth = default(string), string IncludeHMAC = default(string), string PausePublish = default(string), ConnectEventData EventData = default(ConnectEventData))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationConnectConfigurationRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrganizationConnectConfigurationRequest);
        }

        /// <summary>
        /// Returns true if OrganizationConnectConfigurationRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of OrganizationConnectConfigurationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationConnectConfigurationRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
