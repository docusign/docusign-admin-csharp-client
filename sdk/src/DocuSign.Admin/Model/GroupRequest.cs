...
namespace DocuSign.Admin.Model
{
    ...
    public partial class GroupRequest :  IEquatable<GroupRequest>, IValidatableObject
    {
        ...
        public GroupRequest(long? Id = default(long?), string Name = default(string), string Type = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for GroupRequest and cannot be null");
            }
            else
            {
                this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupRequest);
        }

        /// <summary>
        /// Returns true if GroupRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of GroupRequest to be compared</param>
        /// <returns>Boolean</returns>
