...
namespace DocuSign.Admin.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewMultiProductUserAddRequest :  IEquatable<NewMultiProductUserAddRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMultiProductUserAddRequest" /> class.
        /// </summary>
        ...
        public NewMultiProductUserAddRequest(List<ProductPermissionProfileRequest> ProductPermissionProfiles = default(List<ProductPermissionProfileRequest>), List<DSGroupRequest> DsGroups = default(List<DSGroupRequest>), string UserName = default(string), string FirstName = default(string), string LastName = default(string), string Email = default(string), Guid? DefaultAccountId = default(Guid?), string LanguageCulture = default(string), string AccessCode = default(string), string FederatedStatus = default(string), bool? AutoActivateMemberships = default(bool?))
        {
            // to ensure "ProductPermissionProfiles" is required (not null)
            if (ProductPermissionProfiles == null)
            {
                throw new InvalidDataException("ProductPermissionProfiles is a required property for NewMultiProductUserAddRequest and cannot be null");
            }
            else
            {
            ...
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for NewMultiProductUserAddRequest and cannot be null");
            }
            else
            {
                this.Email = Email;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NewMultiProductUserAddRequest);
        }

        /// <summary>
        /// Returns true if NewMultiProductUserAddRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of NewMultiProductUserAddRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewMultiProductUserAddRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
