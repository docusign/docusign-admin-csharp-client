...
namespace DocuSign.Admin.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api.docusign.net/Management");
        }
        ...
        public ApiClient(String basePath = "https://api.docusign.net/Management", WebProxy proxy = null)
        {
            ...
            String contentType)
        {
            ...
            if (postBody != null) // http body (model or byte[]) parameter
            {
                ...
                {
                    request.AddHeader("Content-Disposition", "form-data;name=file; filename=file.csv");
        ...
        public void SetOAuthBasePath(string oAuthBasePath = null)
        {
            ...
            if (this.basePath.StartsWith("https://api-d") || this.basePath.StartsWith("http://api-d"))
            {
                this.oAuthBasePath = OAuth.Demo_OAuth_BasePath;
            }
            else if (this.basePath.StartsWith("https://api-s") || this.basePath.StartsWith("http://api-s"))
            {
